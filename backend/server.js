...
app.get("/", (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      { path: "/api/auth/forgot-password", description: "Demande de réinitialisation de mot de passe" },
      { path: "/api/auth/reset-password",  description: "Réinitialisation du mot de passe" },
      ...
      { path: "/api/payments",             description: "Paiements Stripe" },
      { path: "/api/photos",               description: "Upload et consultation des photos de missions" },
      { path: "/api/providers",            description: "Gestion des prestataires" },
      { path: "/api/documents",            description: "Documents administratifs prestataires" },
      { path: "/api/reviews",              description: "Avis et notations" },
      { path: "/api/notifications",        description: "Notifications utilisateur" },
      { path: "/api/stats",                description: "Statistiques plateforme" },
      { path: "/api/users",                description: "Gestion du profil utilisateur" },
      { path: "/api/admin",                description: "Administration de la plateforme" },
      { path: "/api/admin/messages",       description: "Messages Crisp — dashboard admin" },
      { path: "/api/contact",              description: "Formulaire de contact public" },
      { path: "/api/webhooks",             description: "Webhooks Stripe et Crisp" },
    ]
  });
});
